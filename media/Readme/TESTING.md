...
- [Product Detail](lighthouse-product-detail.png)
- [Bag](lighthouse-bag.png)
- [Checkout](lighthouse-ckeckout.png)
- [Profile](lighthouse-profile.png)
- [Blog](lighthouse-blog.png)
- [Post Detail](lighthouse-blog-detail.png)
- [Add Blog Post](lighthouse-add-blog.png)


### **Validators**

#### **HTML Validator**
I used W3Cs HTML Validator for my code and came with only one error. the error is " Element li not allowed as child of element nav in this context. (Suppressing further errors from this subtree.)" This error relates to the li element in the mobile-top-header.html and is taught to us through the boutique Ado videos and is even referenced in the Boutique Ado final source code. So I have used it as such as its been taught to us through the course. There are no other errors generated by the W3C code.
...
I have run my JS file through JS Hint and have come back with no errors

#### **PEP8**
- Checkout signals imported but not used in problems tab however this is required as it is being accessed elsewhere so the problem can be ignored.  
